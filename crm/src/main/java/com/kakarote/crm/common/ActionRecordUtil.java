...
public class ActionRecordUtil {
    ...
    static {
        ...
        propertiesMap.put(CrmEnum.ORDER.getType(), Dict.create().set("orderNumber", "订单编号").set("title", "订单标题").set("orderStatus", "订单状态").set("logisticsNumber", "物流单号").set("exchangeRate", "汇率换算").set("quoteAmount", "报价金额").set("purchaseCost", "采购成本").set("logisticsCost", "物流成本").set("handlingFeeCost", "平手续成本").set("consumableCost", "耗材成本").set("otherCost", "其他成本").set("profitAmount", "利润金额").set("profitRate", "利润率").set("remark", "备注").set("ownerUserId", "负责人"));
